...
wget -O /etc/pam.d/common-password "https://raw.githubusercontent.com/lesta-2/sc/main/password"
...
wget -q -O /usr/local/bin/edu-proxy https://raw.githubusercontent.com/lesta-2/sc/main/proxy-templated.py
...
wget -q -O /usr/local/bin/edu-proxyssl https://raw.githubusercontent.com/lesta-2/sc/main/proxy-templatedssl.py
...
wget -q -O /usr/local/bin/edu-proxyovpn https://raw.githubusercontent.com/lesta-2/sc/main/proxy-templatedovpn.py
...
# install badvpn
cd
wget -O /usr/bin/badvpn-udpgw "https://raw.githubusercontent.com/lesta-2/sc/main/badvpn-udpgw64"
...
wget -O /etc/squid/squid.conf "https://raw.githubusercontent.com/lesta-2/sc/main/squid3.conf"
...
#OpenVPN
wget https://raw.githubusercontent.com/lesta-2/sc/main/vpn.sh &&  chmod +x vpn.sh && ./vpn.sh
...
wget -O /etc/issue.net "https://raw.githubusercontent.com/lesta-2/sc/main/banner.conf"
...
wget -O menu "https://raw.githubusercontent.com/lesta-2/sc/main/menu.sh"
...
wget -O kernel-updt "https://raw.githubusercontent.com/lesta-2/sc/main/kernel-update.sh"
...
wget -O running "https://raw.githubusercontent.com/lesta-2/sc/main/running.sh"
chmod +x add-host
chmod +x about
chmod +x usernew
chmod +x trial
