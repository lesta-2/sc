...
screen -dmS badvpn badvpn-udpgw --listen-addr 127.0.0.1:7900 --max-clients 500' /etc/bin/wstunnel
systemctl enable xray
systemctl restart xray
systemctl restart nginx
systemctl enable runn
...
curl https://raw.githubusercontent.com/lesta-2/XRAY/main/nginx.conf > /etc/nginx/nginx.conf
curl https://raw.githubusercontent.com/lesta-2/XRAY/main/vps.conf > /etc/nginx/conf.d/vps.conf
...
wget -O /home/vps/public_html/index.html "https://raw.githubusercontent.com/lesta-2/XRAY/main/index.html1"
